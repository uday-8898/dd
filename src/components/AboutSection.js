      ...
      <div className="About-container">
        ...
        <div className="content_boxes">
          <div className="about_content_box">
            <div className="about_detail">
              <div className="about_icon">
                <img src={businessIntelligenceIcon} alt="Business Intelligence" className="img-icon"style={{  marginLeft:"-25px",width: '120px', height: '120px' }}  />
              </div>
          ...
          <div className="about_content_box">
            <div className="about_detail">
              <div className="about_icon">
                <img src={documentSearchIcon} alt="Document Search" className="img-icon" style={{ marginLeft:"-25px", width: '120px', height: '120px' }} />
              </div>
          ...
          <div className="about_content_box">
            <div className="about_detail">
              <div className="about_icon">
                <img src={workflowIcon} alt="Data Workflow" className="img-icon" style={{ marginLeft:"-25px", width: '120px', height: '120px' }} />
              </div>
